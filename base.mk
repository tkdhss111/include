...
DIR_BIN_RLS   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/bin/Release/
DIR_BIN_DBG   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/bin/Debug/
DIR_LIB_RLS   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/lib/Release/
DIR_LIB_DBG   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/lib/Debug/
DIR_OBJ_RLS   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/obj/Release/
DIR_OBJ_DBG   := $(DIR_PROJS)$(DIR_PROJ)$(NAME)/obj/Debug/
